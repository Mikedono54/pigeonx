/**
 * Weekly report arithmetic and wording. The `weekly-report` edge function does
 * the querying and the sending; what a week is and what the email says lives
 * here, where it can be tested without a scheduler.
 */
